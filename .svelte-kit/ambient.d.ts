...
declare module '$env/static/private' {
	...
	export const AZURE_KEYVAULT: string;
	export const CLERK_PUBLISHABLE_KEY: string;
	export const CLERK_SECRET_KEY: string;
	export const GOOGLE_API_KEY: string;
	export const GOOGLE_CLIENT_ID: string;
	export const GOOGLE_CLIENT_SECRET: string;
	export const NEXT_PUBLIC_CLERK_AFTER_SIGN_IN_URL: string;
	export const NEXT_PUBLIC_CLERK_AFTER_SIGN_UP_URL: string;
	export const NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: string;
	export const NEXT_PUBLIC_CLERK_SIGN_IN_URL: string;
	export const NOTION_API_SECRET: string;
	export const NOTION_SOURCE_DB: string;
