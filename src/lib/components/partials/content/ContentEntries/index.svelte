<script lang="ts">
	...
	import ContentEntryGrid from '../ContentEntryGrid/index.svelte';
	import ContentEntryCard, { type EntryStatus } from '$components/parts/content/ContentEntryCard/index.svelte';
...
{#if archived}
	<a href={resolve(`/content`)} class={styles['nav-link']}>← Content</a>
{:else if hasArchive}
	<a href={resolve(`/content/archive`)} class={styles['nav-link']}>View archive</a>
{/if}
