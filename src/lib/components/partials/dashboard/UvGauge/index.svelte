...
<div class="{styles['uv-gauge']} {className}">
	{#if !uv}
		<p class={styles.empty}>No UV entity found - tag one with the house_app label in Home Assistant.</p>
	{:else}
		<svg
			viewBox="0 0 200 115"
			class={styles.gauge}
		...
		<p class={styles.caption}>UV Index</p>
	{/if}
</div>
