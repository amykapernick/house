...
export type Colour = 'purple_bright' | 'purple' | 'purple_light' | 'blue_navy' | 'blue_mid' | 'blue' | 'blue_light' | 'green_teal' | 'green_dark' | 'green' | 'green_light' | 'green_lime' | 'red' | 'pink_dark' | 'pink' | 'orange_peach' | 'orange_dark' | 'orange' | 'yellow' | 'white' | 'grey' | 'grey_dark' | 'grey_light' | 'black'
